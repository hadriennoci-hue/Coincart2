...
export const BackgroundBeams = React.memo(function BackgroundBeams() {
  return (
    ...
    >
      ...
      >
        {/* Static faint background strokes */}
        <path
        ...
        <defs>
          ...
          >
            <stop offset="0.07" stopColor="rgba(255,255,255,0.12)" />
            <stop offset="0.24" stopColor="rgba(255,255,255,0.08)" />
