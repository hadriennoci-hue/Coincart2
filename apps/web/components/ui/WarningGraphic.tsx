...
export function WarningGraphic({
  ...
  const containerVariants = {
    ...
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: shouldAnimate ? 0.15 * s : 0,
        delayChildren: shouldAnimate ? 0.1 * s : 0,
      },
    },
  };
  ...
  const pathLineVariants = {
    ...
    visible: {
      pathLength: 1,
      opacity: 0.3,
      transition: { pathLength: { duration: 1.2 * s, ease: "easeOut" }, delay: 0 },
    },
  };
  ...
  const triangleVariants = {
    ...
    visible: {
      ...
      pathLength: 1,
      transition: {
        pathLength: { duration: 0.8 * s, ease: "easeOut" },
        opacity: { duration: 0.3 * s },
        delay: shouldAnimate ? 0.6 * s : 0,
      },
    },
  };
  ...
  const elementVariants = {
    ...
    visible: {
      ...
      transition: { type: "spring" as const, stiffness: 400, damping: 25, delay: shouldAnimate ? 2.5 * s : 0 },
    },
  };
  ...
  const leftStripeVariants = {
    ...
    visible: {
      opacity: 1, scaleX: 1,
      transition: { type: "spring" as const, stiffness: 400, damping: 30, delay: shouldAnimate ? 1.4 * s : 0 },
    },
  };
  ...
  const stripesContainerVariants = {
    ...
    visible: {
      transition: {
        staggerChildren: shouldAnimate ? 0.08 * s : 0,
        delayChildren: shouldAnimate ? 1.4 * s : 0,
      },
    },
  };
  ...
  const exclamationVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        scale: { times: [0, 0.6, 1], duration: 0.6 * s },
        delay: shouldAnimate ? 2.0 * s : 0,
      },
    },
  };
