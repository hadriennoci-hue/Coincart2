...
export const getOrderById = async (db: Db, orderId: string) => {
  const orderRows = await db
    .select({
      ...
      billingAddress2: orders.billingAddress2,
  ...
  return {
    ...orderRows[0],
    subtotalAmount: Number(orderRows[0].subtotalAmount ?? 0),
    shippingAmount: Number(orderRows[0].shippingAmount ?? 0),
    taxAmount: Number(orderRows[0].taxAmount ?? 0),
    discountAmount: Number(orderRows[0].discountAmount ?? 0),
    couponCode: orderRows[0].couponCode ?? null,
    companyName: orderRows[0].companyName ?? null,
    shippingName: orderRows[0].shippingName ?? null,
    shippingAddress1: orderRows[0].shippingAddress1 ?? null,
    shippingAddress2: orderRows[0].shippingAddress2 ?? null,
    shippingCity: orderRows[0].shippingCity ?? null,
    shippingZip: orderRows[0].shippingZip ?? null,
    shippingCountry: orderRows[0].shippingCountry ?? null,
    billingName: orderRows[0].billingName ?? null,
    billingAddress1: orderRows[0].billingAddress1 ?? null,
    billingAddress2: orderRows[0].billingAddress2 ?? null,
    billingCity: orderRows[0].billingCity ?? null,
    billingZip: orderRows[0].billingZip ?? null,
    billingCountry: orderRows[0].billingCountry ?? null,
    shippingNotes: orderRows[0].shippingNotes ?? null,
